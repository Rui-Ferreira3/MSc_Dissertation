...
HD_PWD='C:/Users/MSI/Rui/MSc_Dissertation/SoC/RVfpgaXilinxIntercon/rvfpga-Extended_AXI_interconnect/rvfpga.runs/interconnect_auto_us_df_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interconnect_auto_us_df_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interconnect_auto_us_df_0.tcl
