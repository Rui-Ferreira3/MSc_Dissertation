...
module accel
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 accel_mem ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME accel_mem, ADDR_WIDTH 32, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN accel_ap_clk_0, DATA_WIDTH 64, FREQ_HZ 50000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 1, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 4, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) output [63:0]accel_mem_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 accel_mem ARID" *) output [3:0]accel_mem_arid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 accel_mem AWID" *) output [3:0]accel_mem_awid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 accel_mem BID" *) input [3:0]accel_mem_bid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 accel_mem RDATA" *) input [63:0]accel_mem_rdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 accel_mem RID" *) input [3:0]accel_mem_rid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 accel_mem WDATA" *) output [63:0]accel_mem_wdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 accel_mem WID" *) output [3:0]accel_mem_wid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 accel_mem WSTRB" *) output [7:0]accel_mem_wstrb;
