...
HD_PWD='C:/Users/catia/Rui/MSc_Dissertation/SoC/RVfpgaXilinxIntercon/RVfpga_test/RVfpga_test.runs/interconnect_s04_mmu_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interconnect_s04_mmu_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interconnect_s04_mmu_0.tcl
