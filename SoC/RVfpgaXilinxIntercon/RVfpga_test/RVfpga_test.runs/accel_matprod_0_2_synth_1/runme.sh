...
HD_PWD='C:/Users/catia/Rui/MSc_Dissertation/SoC/RVfpgaXilinxIntercon/RVfpga_test/RVfpga_test.runs/accel_matprod_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accel_matprod_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accel_matprod_0_2.tcl
