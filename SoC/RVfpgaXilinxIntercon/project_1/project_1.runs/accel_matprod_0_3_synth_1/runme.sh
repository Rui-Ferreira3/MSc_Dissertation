...
HD_PWD='C:/Users/catia/Rui/MSc_Dissertation/SoC/RVfpgaXilinxIntercon/project_1/project_1.runs/accel_matprod_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accel_matprod_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accel_matprod_0_3.tcl
