...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/interconnect/ipshared/ec67/hdl" \
       +incdir+"../../../../project_1.gen/sources_1/bd/interconnect/ipshared/ec67/hdl" \
