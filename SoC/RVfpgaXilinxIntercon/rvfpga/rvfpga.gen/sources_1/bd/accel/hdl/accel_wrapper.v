...
module accel_wrapper
   (accel_ctrl_araddr,
    ...
    clk,
    rst);
  input [5:0]accel_ctrl_araddr;
  output accel_ctrl_arready;
  input accel_ctrl_arvalid;
  input [5:0]accel_ctrl_awaddr;
  ...
  output [0:0]accel_irq;
  output [31:0]accel_mem_araddr;
  ...
  wire [5:0]accel_ctrl_araddr;
  wire accel_ctrl_arready;
  wire accel_ctrl_arvalid;
  wire [5:0]accel_ctrl_awaddr;
