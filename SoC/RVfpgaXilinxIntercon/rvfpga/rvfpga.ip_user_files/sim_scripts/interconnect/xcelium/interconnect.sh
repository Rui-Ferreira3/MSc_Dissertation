...
# Design libraries
design_libs=(simprims_ver xpm generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_27 fifo_generator_v13_2_7 axi_data_fifo_v2_1_26 axi_crossbar_v2_1_28 xil_defaultlib axi_protocol_converter_v2_1_27 axi_clock_converter_v2_1_26 blk_mem_gen_v8_4_5 axi_dwidth_converter_v2_1_27)
...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.interconnect \
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../rvfpga.gen/sources_1/bd/interconnect/ipshared/ec67/hdl" \
       +incdir+"../../../../rvfpga.gen/sources_1/bd/interconnect/ipshared/ec67/hdl" \
       -input simulate.do
}
