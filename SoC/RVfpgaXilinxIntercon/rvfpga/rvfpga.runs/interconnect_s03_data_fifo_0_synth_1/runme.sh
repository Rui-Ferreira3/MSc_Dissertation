...
HD_PWD='C:/Users/Rui/Rui/MSc_Dissertation/SoC/RVfpgaXilinxIntercon/rvfpga/rvfpga.runs/interconnect_s03_data_fifo_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interconnect_s03_data_fifo_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interconnect_s03_data_fifo_0.tcl
