...
HD_PWD='C:/Users/MSI/Rui/MSc_Dissertation/SoC/RVfpgaXilinxIntercon/rvfpga/rvfpga.runs/accel_matprod_0_10_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accel_matprod_0_10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accel_matprod_0_10.tcl
