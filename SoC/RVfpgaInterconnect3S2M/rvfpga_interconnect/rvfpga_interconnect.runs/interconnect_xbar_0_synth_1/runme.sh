...
HD_PWD='C:/Users/Rui/Rui/MSc_Dissertation/SoC/RVfpgaInterconnect3S2M/rvfpga_interconnect/rvfpga_interconnect.runs/interconnect_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interconnect_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interconnect_xbar_0.tcl
