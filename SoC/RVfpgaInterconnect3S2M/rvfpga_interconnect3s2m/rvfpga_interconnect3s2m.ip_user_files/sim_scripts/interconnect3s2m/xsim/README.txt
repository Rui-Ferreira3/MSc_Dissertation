...
#
# Generated by export_simulation on Tue Oct 10 17:24:04 +0100 2023
#
################################################################################
...
'-reset_run' switch to the './interconnect3s2m.sh' script.

./interconnect3s2m.sh -reset_run
...
./interconnect3s2m.sh -noclean_files

For more information on the script, please type './interconnect3s2m.sh -help'.
