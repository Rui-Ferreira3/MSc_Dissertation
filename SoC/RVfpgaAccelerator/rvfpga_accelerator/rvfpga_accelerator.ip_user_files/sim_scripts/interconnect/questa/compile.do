...
vlog -work xpm  -incr -mfcu  -sv "+incdir+../../../../rvfpga_accelerator.gen/sources_1/bd/interconnect/ipshared/ec67/hdl" \
...
vlog -work generic_baseblocks_v2_1_0  -incr -mfcu  "+incdir+../../../../rvfpga_accelerator.gen/sources_1/bd/interconnect/ipshared/ec67/hdl" \
"../../../../rvfpga_accelerator.gen/sources_1/bd/interconnect/ipshared/b752/hdl/generic_baseblocks_v2_1_vl_rfs.v" \

vlog -work axi_infrastructure_v1_1_0  -incr -mfcu  "+incdir+../../../../rvfpga_accelerator.gen/sources_1/bd/interconnect/ipshared/ec67/hdl" \
"../../../../rvfpga_accelerator.gen/sources_1/bd/interconnect/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \

vlog -work axi_register_slice_v2_1_27  -incr -mfcu  "+incdir+../../../../rvfpga_accelerator.gen/sources_1/bd/interconnect/ipshared/ec67/hdl" \
"../../../../rvfpga_accelerator.gen/sources_1/bd/interconnect/ipshared/f0b4/hdl/axi_register_slice_v2_1_vl_rfs.v" \

vlog -work fifo_generator_v13_2_7  -incr -mfcu  "+incdir+../../../../rvfpga_accelerator.gen/sources_1/bd/interconnect/ipshared/ec67/hdl" \
...
vlog -work axi_data_fifo_v2_1_26  -incr -mfcu  "+incdir+../../../../rvfpga_accelerator.gen/sources_1/bd/interconnect/ipshared/ec67/hdl" \
"../../../../rvfpga_accelerator.gen/sources_1/bd/interconnect/ipshared/3111/hdl/axi_data_fifo_v2_1_vl_rfs.v" \

vlog -work axi_crossbar_v2_1_28  -incr -mfcu  "+incdir+../../../../rvfpga_accelerator.gen/sources_1/bd/interconnect/ipshared/ec67/hdl" \
"../../../../rvfpga_accelerator.gen/sources_1/bd/interconnect/ipshared/c40e/hdl/axi_crossbar_v2_1_vl_rfs.v" \

vlog -work xil_defaultlib  -incr -mfcu  "+incdir+../../../../rvfpga_accelerator.gen/sources_1/bd/interconnect/ipshared/ec67/hdl" \
