...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../rvfpga_accelerator.gen/sources_1/bd/interconnect/ipshared/ec67/hdl" \
       +incdir+"../../../../rvfpga_accelerator.gen/sources_1/bd/interconnect/ipshared/ec67/hdl" \
       -input simulate.do
}
