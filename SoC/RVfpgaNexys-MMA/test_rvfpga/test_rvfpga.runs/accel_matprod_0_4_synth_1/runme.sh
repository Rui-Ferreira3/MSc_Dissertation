...
HD_PWD='C:/Users/MSI/Rui/MSc_Dissertation/SoC/RVfpgaXilinxIntercon/test_rvfpga/test_rvfpga.runs/accel_matprod_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accel_matprod_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accel_matprod_0_4.tcl
