...
HD_PWD='C:/Users/MSI/Rui/MSc_Dissertation/SoC/RVfpgaXilinxIntercon/test_rvfpga/test_rvfpga.runs/interconnect_auto_us_df_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interconnect_auto_us_df_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interconnect_auto_us_df_1.tcl
