...
HD_PWD='C:/Users/Rui/Rui/MSc_Dissertation/SoC/RVfpga/rvfpga/rvfpga.runs/axi_interconnect_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_interconnect_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_interconnect_xbar_0.tcl
