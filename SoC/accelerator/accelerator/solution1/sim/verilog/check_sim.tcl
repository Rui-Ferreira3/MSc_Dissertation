...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.matprod.autotvin_gmem.dat"
         "c.matprod.autotvin_m1.dat"
         "c.matprod.autotvin_m2.dat"
         "c.matprod.autotvin_m3.dat"
         "c.matprod.autotvin_N1.dat"
         "c.matprod.autotvin_N2.dat"
         "c.matprod.autotvin_N3.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.matprod.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
