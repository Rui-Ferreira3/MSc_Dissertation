set moduleName matprod_Pipeline_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {matprod_Pipeline_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ p_cast1_cast int 30 regular  }
	{ m2_buffer float 32 regular {array 1024 { 0 3 } 0 1 }  }
	{ sext_ln24 int 32 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "m1","offset": { "type": "dynamic","port_name": "m1","bundle": "BUS1"},"direction": "READONLY"},{"cName": "m2","offset": { "type": "dynamic","port_name": "m2","bundle": "BUS1"},"direction": "READONLY"},{"cName": "m3","offset": { "type": "dynamic","port_name": "m3","bundle": "BUS1"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "p_cast1_cast", "interface" : "wire", "bitwidth" : 30, "direction" : "READONLY"} , 
 	{ "Name" : "m2_buffer", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sext_ln24", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ p_cast1_cast sc_in sc_lv 30 signal 1 } 
	{ m2_buffer_address0 sc_out sc_lv 10 signal 2 } 
	{ m2_buffer_ce0 sc_out sc_logic 1 signal 2 } 
	{ m2_buffer_we0 sc_out sc_logic 1 signal 2 } 
	{ m2_buffer_d0 sc_out sc_lv 32 signal 2 } 
	{ sext_ln24 sc_in sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_cast1_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "p_cast1_cast", "role": "default" }} , 
 	...
 	{ "name": "m2_buffer_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "m2_buffer", "role": "we0" }} , 
 	{ "name": "m2_buffer_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "m2_buffer", "role": "d0" }} , 
 	{ "name": "sext_ln24", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sext_ln24", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4", "Max" : "4611686018427387906"}
	, {"Name" : "Interval", "Min" : "4", "Max" : "2"}
]}
...
set Spec2ImplPortList { 
	...
	p_cast1_cast { ap_none {  { p_cast1_cast in_data 0 30 } } }
	m2_buffer { ap_memory {  { m2_buffer_address0 mem_address 1 10 }  { m2_buffer_ce0 mem_ce 1 1 }  { m2_buffer_we0 mem_we 1 1 }  { m2_buffer_d0 mem_din 1 32 } } }
	sext_ln24 { ap_none {  { sext_ln24 in_data 0 32 } } }
}
