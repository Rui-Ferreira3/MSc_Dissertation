set moduleName matprod_Pipeline_VITIS_LOOP_28_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {matprod_Pipeline_VITIS_LOOP_28_3}
...
set C_modelArgMapList {[ 
	{ "Name" : "N2", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "trunc_ln1", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ trunc_ln sc_in sc_lv 10 signal 3 } 
	{ trunc_ln1 sc_in sc_lv 10 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "trunc_ln1", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "trunc_ln1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	trunc_ln1 { ap_none {  { trunc_ln1 in_data 0 10 } } }
