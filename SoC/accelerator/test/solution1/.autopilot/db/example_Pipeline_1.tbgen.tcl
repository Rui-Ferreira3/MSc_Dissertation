set moduleName example_Pipeline_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {example_Pipeline_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ sext_ln37 int 62 regular  }
	{ buff int 32 regular {array 50 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "a","offset": { "type": "dynamic","port_name": "a","bundle": "control"},"direction": "READWRITE"}]}]} , 
...
set portList { 
	...
	{ buff_address0 sc_out sc_lv 6 signal 2 } 
	{ buff_ce0 sc_out sc_logic 1 signal 2 } 
	{ buff_we0 sc_out sc_logic 1 signal 2 } 
	{ buff_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	buff { ap_memory {  { buff_address0 mem_address 1 6 }  { buff_ce0 mem_ce 1 1 }  { buff_we0 mem_we 1 1 }  { buff_d0 mem_din 1 32 } } }
}
