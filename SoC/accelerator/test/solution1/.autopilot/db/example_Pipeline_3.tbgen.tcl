set moduleName example_Pipeline_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {example_Pipeline_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 1}  }
	{ sext_ln37 int 62 regular  }
	{ buff int 32 regular {array 50 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "a","offset": { "type": "dynamic","port_name": "a","bundle": "control"},"direction": "READWRITE"}]}]} , 
...
set Spec2ImplPortList { 
	...
	buff { ap_memory {  { buff_address0 mem_address 1 6 }  { buff_ce0 mem_ce 1 1 }  { buff_q0 mem_dout 0 32 } } }
}
