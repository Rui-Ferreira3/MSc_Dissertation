...
# 25 "test/example.cpp" 2

__attribute__((sdx_kernel("example", 0))) void example(volatile int* a) {
#line 14 "C:/Users/Rui/Rui/MSc_Dissertation/SoC/accelerator/test/solution1/csynth.tcl"
...
#pragma HLS INTERFACE m_axi port = a depth = 50
 ...
 int i;
    ...
    VITIS_LOOP_39_1: for (i = 0; i < 50; i++) {
        buff[i] = buff[i] + 100;
    }
