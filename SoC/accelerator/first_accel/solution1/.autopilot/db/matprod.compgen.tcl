...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler matprod_gmem_m_axi BINDTYPE {interface} TYPE {adapter} IMPL {m_axi}
}
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 32 \
			corename matprod_BUS1_axilite \
			name matprod_BUS1_s_axi \
			ports {$port_BUS1} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler matprod_BUS1_s_axi BINDTYPE interface TYPE interface_s_axilite
}
