...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln26_1 \
    op interface \
    ports { mul_ln26_1 { I 10 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_regc \
    op interface \
    ports { regc_i { I 32 vector } regc_o { O 32 vector } regc_o_ap_vld { O 1 bit } } \
} "
}
