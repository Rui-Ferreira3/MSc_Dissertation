...
set C_modelArgList {
	...
	{ m1_buffer double 64 regular {array 1024 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "m1","offset": { "type": "dynamic","port_name": "m1","bundle": "BUS1"},"direction": "READONLY"},{"cName": "m2","offset": { "type": "dynamic","port_name": "m2","bundle": "BUS1"},"direction": "READONLY"},{"cName": "m3","offset": { "type": "dynamic","port_name": "m3","bundle": "BUS1"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "m1_buffer", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ m1_buffer_d0 sc_out sc_lv 64 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m1_buffer_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "m1_buffer", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	...
	m1_buffer { ap_memory {  { m1_buffer_address0 mem_address 1 10 }  { m1_buffer_ce0 mem_ce 1 1 }  { m1_buffer_we0 mem_we 1 1 }  { m1_buffer_d0 mem_din 1 64 } } }
