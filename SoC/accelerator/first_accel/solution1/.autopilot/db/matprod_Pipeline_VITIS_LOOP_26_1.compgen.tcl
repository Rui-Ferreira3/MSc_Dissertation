...
set ce_signed 0
set out_width 10
set arg_lists {i0 {10 1 +} i1 {10 1 +} m {10 1 +} i2 {10 1 +} p {10 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_trunc_ln6_1 \
    op interface \
    ports { trunc_ln6_1 { I 10 vector } } \
} "
}
...
set InstName matprod_flow_control_loop_pipe_sequential_init_U
set CompName matprod_flow_control_loop_pipe_sequential_init
