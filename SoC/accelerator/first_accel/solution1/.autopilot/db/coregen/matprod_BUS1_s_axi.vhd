        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_N2_DATA_0 =>
                        rdata_data <= RESIZE(int_N2(31 downto 0), 32);
                    when ADDR_N3_DATA_0 =>
                        rdata_data <= RESIZE(int_N3(31 downto 0), 32);
                    when others =>
                        NULL;
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    m3                   <= STD_LOGIC_VECTOR(int_m3);
    N1                   <= STD_LOGIC_VECTOR(int_N1);
    N2                   <= STD_LOGIC_VECTOR(int_N2);
    N3                   <= STD_LOGIC_VECTOR(int_N3);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_N1_DATA_0) then
                    int_N1(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_N1(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_N2_DATA_0) then
                    int_N2(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_N2(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_N3_DATA_0) then
                    int_N3(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_N3(31 downto 0));
                end if;
            end if;
        end if;
    end process;
