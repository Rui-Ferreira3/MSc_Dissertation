set moduleName matprod_Pipeline_VITIS_LOOP_37_6
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {matprod_Pipeline_VITIS_LOOP_37_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 1}  }
	{ sext_ln37 int 30 regular  }
	{ mul58 int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "m1","offset": { "type": "dynamic","port_name": "m1","bundle": "BUS1"},"direction": "READONLY"},{"cName": "m2","offset": { "type": "dynamic","port_name": "m2","bundle": "BUS1"},"direction": "READONLY"},{"cName": "m3","offset": { "type": "dynamic","port_name": "m3","bundle": "BUS1"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln37", "interface" : "wire", "bitwidth" : 30, "direction" : "READONLY"} , 
 	{ "Name" : "mul58", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln37 sc_in sc_lv 30 signal 1 } 
	{ mul58 sc_in sc_lv 32 signal 2 } 
	{ m3_buffer_address0 sc_out sc_lv 10 signal 3 } 
	{ m3_buffer_ce0 sc_out sc_logic 1 signal 3 } 
	{ m3_buffer_q0 sc_in sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln37", "direction": "in", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "sext_ln37", "role": "default" }} , 
 	{ "name": "mul58", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "mul58", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln37 { ap_none {  { sext_ln37 in_data 0 30 } } }
	mul58 { ap_none {  { mul58 in_data 0 32 } } }
