...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matprod.autotvin.dat"
	set constFileTvOut       "matprod.autotvout.dat"
	set constFileHdlTvIn     "matprod.autohdltvin.dat"
	set constFileHdlTvOut    "matprod.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
