...
reg   [9:0] empty_reg_337;
wire  signed [9:0] empty_20_fu_160_p1;
reg  signed [9:0] empty_20_reg_343;
wire  signed [9:0] empty_21_fu_164_p1;
reg  signed [9:0] empty_21_reg_349;
wire   [0:0] icmp_ln28_fu_168_p2;
reg   [0:0] icmp_ln28_reg_355;
reg   [0:0] icmp_ln28_reg_355_pp0_iter1_reg;
reg   [0:0] icmp_ln28_reg_355_pp0_iter2_reg;
reg   [0:0] icmp_ln28_reg_355_pp0_iter3_reg;
wire   [0:0] icmp_ln31_fu_180_p2;
reg   [0:0] icmp_ln31_reg_360;
reg   [0:0] icmp_ln31_reg_360_pp0_iter1_reg;
reg   [0:0] icmp_ln31_reg_360_pp0_iter2_reg;
reg   [0:0] icmp_ln31_reg_360_pp0_iter3_reg;
reg   [63:0] m1_buffer_load_reg_369;
reg   [63:0] m2_buffer_load_reg_379;
...
wire   [9:0] grp_fu_280_p3;
reg  signed [9:0] add_ln33_reg_384;
reg  signed [9:0] add_ln33_reg_384_pp0_iter2_reg;
reg  signed [9:0] add_ln33_reg_384_pp0_iter3_reg;
wire   [63:0] grp_fu_123_p2;
reg   [63:0] mul_reg_389;
reg   [63:0] mul_reg_389_pp0_iter3_reg;
wire    ap_block_pp0_stage3_11001;
wire   [63:0] grp_fu_119_p2;
reg   [63:0] add_reg_400;
...
wire   [63:0] select_ln28_fu_251_p3;
...
matprod_dadd_64ns_64ns_64_4_full_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
...
matprod_dmul_64ns_64ns_64_4_max_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 64 ),
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
dmul_64ns_64ns_64_4_max_dsp_1_U10(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2) & (icmp_ln31_reg_360_pp0_iter1_reg == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2) & (icmp_ln28_reg_355_pp0_iter3_reg == 1'd0))) begin
...
always @ (*) begin
    if (((icmp_ln26_reg_333 == 1'd0) & (1'b0 == ap_block_pp0_stage3_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage3_11001) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3) & (icmp_ln31_reg_360_pp0_iter3_reg == 1'd1))) begin
        m3_buffer_we0 = 1'b1;
    end else begin
        m3_buffer_we0 = 1'b0;
    end
...
assign grp_fu_267_p0 = i_fu_46[9:0];
...
assign m3_buffer_address0 = zext_ln33_fu_263_p1;

assign m3_buffer_d0 = ((icmp_ln28_reg_355_pp0_iter3_reg[0:0] == 1'b1) ? mul_reg_389_pp0_iter3_reg : add_reg_400);

assign select_ln28_fu_251_p3 = ((icmp_ln28_reg_355_pp0_iter3_reg[0:0] == 1'b1) ? mul_reg_389_pp0_iter3_reg : add_reg_400);

assign zext_ln27_1_fu_242_p0 = grp_fu_274_p3;

assign zext_ln27_1_fu_242_p1 = $unsigned(zext_ln27_1_fu_242_p0);

assign zext_ln27_fu_238_p0 = grp_fu_267_p3;

assign zext_ln27_fu_238_p1 = $unsigned(zext_ln27_fu_238_p0);

assign zext_ln33_fu_263_p1 = $unsigned(add_ln33_reg_384_pp0_iter3_reg);
