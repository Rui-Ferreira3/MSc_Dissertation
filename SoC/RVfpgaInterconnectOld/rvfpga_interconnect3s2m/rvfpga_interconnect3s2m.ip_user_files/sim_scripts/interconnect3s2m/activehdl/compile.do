...
vlog -work xpm  -sv2k12 "+incdir+../../../../rvfpga_interconnect3s2m.gen/sources_1/bd/interconnect3s2m/ipshared/ec67/hdl" \
...
vlog -work generic_baseblocks_v2_1_0  -v2k5 "+incdir+../../../../rvfpga_interconnect3s2m.gen/sources_1/bd/interconnect3s2m/ipshared/ec67/hdl" \
"../../../../rvfpga_interconnect3s2m.gen/sources_1/bd/interconnect3s2m/ipshared/b752/hdl/generic_baseblocks_v2_1_vl_rfs.v" \

vlog -work axi_infrastructure_v1_1_0  -v2k5 "+incdir+../../../../rvfpga_interconnect3s2m.gen/sources_1/bd/interconnect3s2m/ipshared/ec67/hdl" \
"../../../../rvfpga_interconnect3s2m.gen/sources_1/bd/interconnect3s2m/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \

vlog -work axi_register_slice_v2_1_27  -v2k5 "+incdir+../../../../rvfpga_interconnect3s2m.gen/sources_1/bd/interconnect3s2m/ipshared/ec67/hdl" \
"../../../../rvfpga_interconnect3s2m.gen/sources_1/bd/interconnect3s2m/ipshared/f0b4/hdl/axi_register_slice_v2_1_vl_rfs.v" \

vlog -work fifo_generator_v13_2_7  -v2k5 "+incdir+../../../../rvfpga_interconnect3s2m.gen/sources_1/bd/interconnect3s2m/ipshared/ec67/hdl" \
...
vlog -work axi_data_fifo_v2_1_26  -v2k5 "+incdir+../../../../rvfpga_interconnect3s2m.gen/sources_1/bd/interconnect3s2m/ipshared/ec67/hdl" \
"../../../../rvfpga_interconnect3s2m.gen/sources_1/bd/interconnect3s2m/ipshared/3111/hdl/axi_data_fifo_v2_1_vl_rfs.v" \

vlog -work axi_crossbar_v2_1_28  -v2k5 "+incdir+../../../../rvfpga_interconnect3s2m.gen/sources_1/bd/interconnect3s2m/ipshared/ec67/hdl" \
"../../../../rvfpga_interconnect3s2m.gen/sources_1/bd/interconnect3s2m/ipshared/c40e/hdl/axi_crossbar_v2_1_vl_rfs.v" \

vlog -work xil_defaultlib  -v2k5 "+incdir+../../../../rvfpga_interconnect3s2m.gen/sources_1/bd/interconnect3s2m/ipshared/ec67/hdl" \
