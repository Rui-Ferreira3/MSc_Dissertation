...
HD_PWD='C:/Users/Rui/Rui/MSc_Dissertation/SoC/RVfpgaInterconnect3S2M/rvfpga_interconnect3s2m/rvfpga_interconnect3s2m.runs/interconnect3s2m_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interconnect3s2m_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interconnect3s2m_xbar_0.tcl
